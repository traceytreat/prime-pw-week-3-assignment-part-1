...
let favoriteFoods = ['noodles', 'squid', 'octopus', 'tofu', 'mushrooms'];
...
favoriteFoods[1] = "hot dogs";
console.log("The updated favorite foods are now", favoriteFoods);

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
favoriteFoods.sort().reverse();
console.log("The sorted array is now", favoriteFoods);

// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.
let s = "";
for (i=0; i<favoriteFoods.length-1; i++){
    s += favoriteFoods[i];
    s += " and ";
}
s += favoriteFoods[favoriteFoods.length-1];
console.log(s);
...
console.log("The combined array is now", combinedArray);